        ...
        <div className="w-full md:w-1/2 bg-white/85 backdrop-blur-xl px-6 md:px-10 py-10 flex flex-col justify-center gap-5">
          <div className="text-center md:text-left mb-2">
            ...
            <p className="text-gray-500 mt-2 text-base md:text-lg">
              Login to your account with a modern experience
            </p>
          </div>
          ...
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full h-14 px-4 pt-5 rounded-2xl border border-gray-300 bg-white/80 outline-none transition-all duration-300 focus:border-orange-500 focus:ring-4 focus:ring-orange-200 shadow-sm hover:shadow-md"
            />
            <label
              htmlFor="email"
          ...
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full h-14 px-4 pt-5 pr-12 rounded-2xl border border-gray-300 bg-white/80 outline-none transition-all duration-300 focus:border-orange-500 focus:ring-4 focus:ring-orange-200 shadow-sm hover:shadow-md"
            />
            <label
              htmlFor="password"
              className={`absolute left-4 transition-all duration-300 pointer-events-none ${
          ...
          <span
            className="text-[14px] cursor-pointer text-gray-600 hover:text-orange-600 transition w-fit"
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-8 text-white [transform:translateZ(40px)]">
              ...
              <p className="mt-5 text-gray-200 leading-7 max-w-md text-[17px]">
                Continue your journey, access your courses, and learn with a beautiful modern platform made for future developers.
              </p>
